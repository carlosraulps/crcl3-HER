...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{arxiv/figures/CrCl3_ads_top.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\linewidth]{arxiv/figures/AIMD_Cr_Supp.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\linewidth]{arxiv/figures/Energies_Temperatures_AIMD_run_2.png}
