...
\response We thank the Reviewer for identifying this omission. The dominant TM--CrCl$_3$ and TM--H interactions are covalent (TM--Cl ICOHP $= -6.2$ to $-11.4\text{ eV}$; TM--H bond lengths 1.43--1.57~\AA). Dispersion corrections would contribute $\sim$0.1--0.4~eV to TM binding energies -- insufficient to alter the metal ranking or motif comparison. For the desorbed pristine H configurations (S$_1$, S$_2$: $d > 3.42\text{ \AA}$), the conclusion is unchanged: no locally stable chemisorbed state exists regardless of dispersion.

\manuscriptchange{\textbf{[Location: \textit{manuscript\_marked.pdf: Pages 6--7, Lines 136--144} \textbar\ \textit{manuscript\_clean.tex: Line 154} \textbar\ \textit{manuscript\_marked.tex: Line 173}]}\\ An explicit statement has been added to Section~2 (highlighted in blue): ``{\itshape \ExecuteMetaData[manuscript_marked.tex]{DispersionCorrection}}''}
