#!/usr/bin/env python3
"""
PHYSICAL & COORDINATION ANALYSIS: Fe ADSORPTION SITES ON CrCl3 (2x2)
"""
import math
import numpy as np
...
def main():
    print("=" * 80)
    print("   COORDINATION SPHERE AND INTERATOMIC DISTANCE ANALYSIS FOR Fe")
    print("=" * 80)
    ...
    print("  Fe placement: ({:.3f}, {:.3f}, {:.3f}) A".format(*s1_tm_cart))
    print("  Direct Fe-Cl11 distance: {:.4f} A".format(d_s1_cl))
    ...
    print("  Fe placement: ({:.3f}, {:.3f}, {:.3f}) A".format(*s2_tm_cart))
    ...
    print("  Fe placement: ({:.3f}, {:.3f}, {:.3f}) A".format(*s3_tm_cart))
    print("  Direct Fe-Cr3 distance: {:.4f} A".format(d_s3_cr))
