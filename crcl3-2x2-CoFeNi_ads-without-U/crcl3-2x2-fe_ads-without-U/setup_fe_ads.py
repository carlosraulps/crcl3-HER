#!/usr/bin/env python3
"""
SETUP Fe ADSORPTION ON PRISTINE CrCl3 2x2 SUPERCELL (No Hubbard U)
"""
import os
import sys
import math
...
POTCAR_TM = os.path.join(os.path.expanduser("~"), "temporary", "dotfiles",
                         "potentials", "potpaw_PBE.64", "Fe", "POTCAR")
...
TM_SYMBOL = "Fe"
TM_MAGMOM = 4.0
TM_MOM_DESC = "4.0 for Fe (d6 high-spin, 4 unpaired electrons)"
DIST_S1 = 2.25
DIST_S2 = 1.9
DIST_S3 = 2.45
