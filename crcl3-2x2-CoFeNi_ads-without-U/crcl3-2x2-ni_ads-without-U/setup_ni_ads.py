#!/usr/bin/env python3
"""
SETUP Ni ADSORPTION ON PRISTINE CrCl3 2x2 SUPERCELL (No Hubbard U)
"""
import os
import sys
import math
...
POTCAR_TM = os.path.join(os.path.expanduser("~"), "temporary", "dotfiles",
                         "potentials", "potpaw_PBE.64", "Ni", "POTCAR")
...
TM_SYMBOL = "Ni"
TM_MAGMOM = 2.0
TM_MOM_DESC = "2.0 for Ni (d8 high-spin, 2 unpaired electrons)"
DIST_S1 = 2.25
DIST_S2 = 1.9
DIST_S3 = 2.45
