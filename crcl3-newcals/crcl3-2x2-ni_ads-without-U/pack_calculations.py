...
================================================================================
 Packs the staged CrCl3 2x2 Ni adsorption calculation directories into
...
TAR_NAME = "crcl3_2x2_ni_ads_without_U.tar.gz"
ZIP_NAME = "crcl3_2x2_ni_ads_without_U.zip"

INCLUDE_DIRS = ["no_vdw", "yes_vdw"]
INCLUDE_FILES = [
    "setup_ni_ads.py",
    "verify_supercell.py",
    "calculate_ni_adsorption_physics.py",
...
def main():
    print("=" * 80)
    print(" PACKING CrCl3 2x2 NI ADSORPTION CALCULATIONS")
    print("=" * 80)
    make_tar()
    make_zip()
    print("\n" + "=" * 80)
